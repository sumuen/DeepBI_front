      ...
      <div className="select-content-item">
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "baseline" }}>
          <div className="select-main" style={{ margin: "0" }}>
            <ul className={!SchemaListIsShow ? "flex-center" : ""} style={{ height: "15vh" }}>
        ...
        <div className="table-columns">
          ...
          <div className={!tableIsShow ? "flex-center" : ""} style={{ width: "54vw", overflowY: "scroll", height: tableIsShow ? "35vh" : "38vh" }}>
            {tableIsShow && (
              <Table
